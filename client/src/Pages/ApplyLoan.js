...
const validationSchema = Yup.object({
    ...
    front:Yup.string().required('Front ID Image required'),
    back:Yup.string().required('Back ID Image required'),
...
const ApplyLoan = ()=>{
    ...
    <DashboardWrapper>
        ...
        {complete && <div>
            ...
            <Details detail='Full Name' icon={<MdOutlinePersonPin/>}/>
            <Details detail='Email' icon={<TfiEmail/>}/>
            <Details detail='Phone Number' icon={<FcPhone/>}/>
            ...
            <div onClick={handleSubmit} className="flex mt-5">
             <button type="submit" className="bg-green-500 text-white h-10 w-20 rounded-md hover:bg-blue-500" >Done</button>
