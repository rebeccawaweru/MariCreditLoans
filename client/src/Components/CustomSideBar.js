...
export default function CustomSideBar(){
    return(
    <div className="h-screen fixed top-0 w-20 lg:w-40 md:w-40 xl:w-50 2xl:w-50 bg-green-400 text-center text-black justify-center items-center">
     ...
     <h2 className='text-sm lg:text-xl md:text-xl xl:text-2xl 2xl:text-3xl font-bold font-Italianno'>MariCredit</h2>
      <ul className='space-y-8 px-6 lg:px-5 md:px-5 xl:px-5 2xl:px-5'>
        ...
        <li className="flex text-left space-x-2">
        <FcHome className="text-xl"/>   
        <p className="hidden lg:block md:block xl:block 2xl:block">Loans</p>
        </li>
        <li className="flex text-left space-x-2">
        <FcHome className="text-xl"/>   
        <p className="hidden lg:block md:block xl:block 2xl:block"> Products</p>
        </li>
        <li className="flex text-left space-x-2">
        ...
        <p className="hidden lg:block md:block xl:block 2xl:block">Payments</p>
        </li>
        <li className="flex text-left space-x-2">
        <FcFolder className="text-xl"/>
        <p className="hidden lg:block md:block xl:block 2xl:block">Report</p>
        </li>
      </ul>
